# Array of Strings ([PoolStringArray]) that can be saved in disk like a custom resource. 
...
tool
class_name PoolStringArrayVariable
...
var value: PoolStringArray = [] setget _set_value, _get_value

# Defautl value in case you're using `is_session_only`
var default_value: PoolStringArray = [] setget _set_default_value, _get_default_value
...
func is_class(p_class: String) -> bool:
	return p_class == "PoolStringArrayVariable" or .is_class(p_class)


func get_class() -> String:
	return "PoolStringArrayVariable"
...
func has(p_string: String) -> bool:
	...
	var has_found: = array.has(p_string)
	return has_found
...
func _set_value(p_value: PoolStringArray) -> void:
...
func _get_value() -> PoolStringArray:
	var meta_value = PoolStringArray()
	if _should_reset_value():
...
func _set_default_value(p_value: PoolStringArray) -> void:
...
func _get_default_value() -> PoolStringArray:
	var meta_value = PoolStringArray()
