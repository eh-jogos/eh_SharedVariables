...
var default_value: Dictionary = {} setget _set_default_value, _get_default_value
...
func _set_default_value(p_value: Dictionary) -> void:
...
func _get_default_value() -> Dictionary:
	var meta_value = {}
