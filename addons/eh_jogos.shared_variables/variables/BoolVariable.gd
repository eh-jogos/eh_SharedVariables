...
var value: bool = true setget _set_value, _get_value

# Defautl value in case you're using `is_session_only`
var default_value: bool = true setget _set_default_value, _get_default_value
...
func _get_value() -> bool:
	...
	elif value == true and has_meta("value"):
...
func _set_default_value(p_value: bool) -> void:
...
func _get_default_value() -> bool:
	var meta_value = true
	if default_value == true and has_meta("default_value"):
		meta_value = get_meta("default_value")
	else:
