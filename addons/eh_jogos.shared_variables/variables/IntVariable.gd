...
var default_value: int = 0 setget _set_default_value, _get_default_value
...
func _get_value() -> int:
	...
	elif value == 0 and has_meta("value"):
...
func _set_default_value(p_value: int) -> void:
...
func _get_default_value() -> int:
	var meta_value = 0
	if default_value == 0 and has_meta("default_value"):
		meta_value = get_meta("default_value")
	else:
