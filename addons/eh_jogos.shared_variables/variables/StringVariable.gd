...
var default_value: String = "" setget _set_default_value, _get_default_value
...
func _set_default_value(p_value: String) -> void:
...
func _get_default_value() -> String:
	var meta_value = ""
	if default_value == "" and has_meta("default_value"):
		meta_value = get_meta("default_value")
	else:
